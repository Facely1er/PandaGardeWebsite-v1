        ...
        <div className="container">
          <div className="section-header fade-in" style={{ marginBottom: '3rem', textAlign: 'center' }}>
            ...
            <p style={{
              ...
              margin: '0 auto',
              lineHeight: '1.6'
            }}>Everything you need, all in one place, completely free</p>
          </div>
          ...
          <div style={{ 
            ...
            {[
              { text: '100% Free - No hidden costs', icon: CheckCircle, color: '#10b981' },
              { text: 'Age-appropriate for kids 5-17', icon: Baby, color: '#3b82f6' },
              { text: 'Fun, interactive activities', icon: Star, color: '#f59e0b' },
              { text: 'Expert guidance for parents', icon: Shield, color: '#9333ea' },
              { text: 'Privacy-first design', icon: Heart, color: '#ef4444' },
              { text: 'Track progress together', icon: Users, color: '#14b8a6' }
            ].map((item, index) => (
              <div
                key={index}
                className="fade-in"
