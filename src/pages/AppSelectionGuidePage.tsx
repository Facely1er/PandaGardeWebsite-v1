...
import { ArrowLeft, Smartphone, Star, Shield, AlertTriangle, CheckCircle, Search, Download } from 'lucide-react';
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="text-center">
            ...
            <h1 className="text-5xl font-bold mb-6 leading-tight">
              Choosing Child-Safe Apps
            </h1>

            <p className="text-xl opacity-90 max-w-2xl mx-auto">
              Comprehensive guide to selecting appropriate digital content and apps for children of all ages. Learn what to look for and what to avoid.
            </p>
          </div>
        </div>
      </header>
