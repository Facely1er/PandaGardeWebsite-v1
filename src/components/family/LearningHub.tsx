...
const LearningHub: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-purple-50 to-indigo-50 dark:from-gray-900 dark:to-gray-800 p-6">
      <div className="max-w-7xl mx-auto">
        {/* Header - Purple Theme */}
        <div className="mb-8">
          <button
            onClick={handleBack}
            className="mb-4 flex items-center space-x-2 text-purple-600 dark:text-purple-300 hover:text-purple-800 dark:hover:text-purple-100 transition-colors"
          >
            <ArrowLeft size={20} />
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              <h1 className="text-4xl font-bold text-purple-800 dark:text-gray-100 flex items-center space-x-3">
                ...
                <div className="p-4">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                      game.difficulty === 'Easy' ? 'bg-violet-100 text-violet-800 dark:bg-violet-900/20 dark:text-violet-300' :
        ...
        {/* Journey Hub Section - Purple Theme */}
        <div className="mt-8 bg-gradient-to-r from-violet-700 via-purple-600 to-fuchsia-600 rounded-xl p-6 text-white">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-white text-purple-700 px-6 py-3 rounded-lg font-semibold hover:bg-amber-300 hover:text-purple-800 transition-all w-full md:w-auto justify-center"
            >
        ...
        <div className="mt-8 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-6">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="font-semibold text-purple-800 dark:text-purple-200 mb-2">Learning Tips for Parents</h4>
